...
{
    [Subject("Tools.Diff")]
    public class When_diffing_unequal_instances_10 : DiffTestsBase
    {
        Establish context = () =>
        {
            SetupMocks();
            ...
            TestInstance2.PropComplexArray_IgnoreOrder = PropComplexArray_IgnoreOrder;
        };
        ...
        It should_contain_9_differences = () => Result.ShouldContainOnly(
            ...
            new KeyValuePair<string, object>("PropComplexArray_IgnoreOrder", PropComplexArray_IgnoreOrder)
        );
        ...
        static Complex[] PropComplexArray_IgnoreOrder;
